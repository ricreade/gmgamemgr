...
{
    /// <summary>
    /// An abstract class representing an integration for a record data 
    /// source for application data.  This class is intended to
    /// support abstraction for varying data sources.
    /// The implementation of this abstract class will likely
    /// be tightly coupled with the implementation of IDataRecordset,
    /// so an initiative to create one will likely necessitate a new
    /// implementation of the other.
    /// </summary>
    public abstract class DataIntegration : IntegrationObject
    {
        ...
        public abstract IDataRecordset SendDataRequest(RecordType Record, IDataParameter[] Args);
        ...
        public abstract bool SetConnectionString(string ConnectionString);
    }
}
